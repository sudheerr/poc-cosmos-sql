@echo off
REM Batch script to create .NET 8 Solution with Clean Architecture
...
del tests\Domain.Tests\UnitTest1.cs 2>nul
del tests\API.Tests\UnitTest1.cs 2>nul
del tests\Infrastructure.Tests\UnitTest1.cs 2>nul
